...
class FundingRightController extends Controller
{
    public function instance()
    {
        ...
        return view('accounting.right.instance')->with([
            'datas' => $datas,
        ]);
    }
    ...
    public function mediaberbagi()
    {
        ...
        return view('accounting.right.mediaberbagi')->with([
            'datas' => $datas,
        ]);
    }
    ...
    public function create($right)
    {
        ...
        return view('accounting.right.form')->with([
            'projects' => $projects,
    ...
    public function store($type, Request $request)
    {
        ...
        return redirect('/accounting/' . $type);
    }

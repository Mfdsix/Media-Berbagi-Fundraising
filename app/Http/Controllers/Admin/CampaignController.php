...
class CampaignController extends Controller
{
    ...
    public function create()
    {
        ...
        return view('admin.campaign.form')->with([
    ...
    public function store(Request $request)
    {
        ...
        return redirect('admin/campaign')->with([
    ...
    public function instantUpdate(Request $request) {
        ...
        $data = InstantProgram::where('program', 'sedekah')->firstOrFail();
    ...
    //create functon viewarchive
    public function archive()
    {
        $data = Project::where('status', 0)
            ->orderBy('id', 'desc')
            ->paginate(25);
        return view('admin.campaign.archive')->with([
            'datas' => $data,
        ]);
    }
    ...
    public function restore($id)
    {
        ...
        return redirect('admin/archive')->with([
            'success' => 'Berhasil Mengembalikan Penggalangan Dana',
        ]);
    }

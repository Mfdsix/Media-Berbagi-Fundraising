		...
		<div class="bg-white rounded p-4 mb-2">
			...
			<div class="border rounded p-4 mb-4">
				<div class="row">
					...
					<div class="col-7 text-right font-weight-bold">Rp{{ number_format($data->grand_total, 0, ',', '.') }}</div>
				</div>
				<hr>
				<div class="row">
					<div class="col-5">Batas Tanggal</div>
					<div class="col-7 text-right font-weight-bold">{{ \Carbon\Carbon::createFromFormat('Y-m-d H:i:s',$data->expire_at)->format('d M Y') }}</div>
				</div>
				<hr>
				<div class="row">

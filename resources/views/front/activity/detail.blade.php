...
<nav id="nav-top-secondary">
    <div class="container h-100">
        <div class="row h-100 d-flex align-items-center">
            ...
            <div class="col-8">
                <h1 class="nav-top-secondary__title">{{ $activity->title }}</h1>
            </div>
            <div class="col-2 text-right">
                <button type="button" class="header-button-share" id="share-button">
...
<header id="page-detail-article-header" style="background-image: url('{{ asset('storage/'.$activity->path) }}');">
    <div class="container">
        <div class="row">
...
<section id="page-detail-article-section" class="bg-white">
    <div class="container">
        <div class="row">
            <div class="col-12">
                <article class="page-detail-article-section__article">
                    <h1 class="page-detail-article-section__title">{{ $activity->title }}</h1>
                    <p class="page-detail-article-section__date__read">{{ Date('d M Y', strtotime($activity->created_at)) }}</p>
                </article>
                <!-- LINE -->
...
<main id="page-detail-article-main" class="min-vh-50 bg-white">
    <div class="container">
        <div class="row">
            <div class="col-12">
                <article class="page-detail-article-main__article mb-4 pb-5">
                    {!! $activity->content ?? '<i>Konten Belum Tersedia</i>' !!}
                </article>
            </div>
        </div>
    </div>
...
<nav id="nav-bottom-share-daftar-kegiatan">
    <div class="container h-100">
        <div class="row h-100">
            <div class="col-12 d-flex align-items-center justify-content-between">
                <a href="{{ $activity->direct_link ?? 'https://wa.me/?phone='.$phone.'&text=Saya+ingin+daftar+kegiatan' }}" class="nav-bottom-share-daftar-kegiatan__kegiatan w-100">{{ $activity->link }}</a>
            </div>
        </div>
    </div>
</nav>
...
<div id="nav-share-section">
    <div class="container">
        ...
        <div class="row mb-4">
            <a href="http://www.facebook.com/sharer.php?u={{ Request::url() }}&t={{ $activity->title }}" target="blank" rel="noopener noreferrer" title="Share this on Facebook" class="col-4 text-center">
            ...
            <a href="http://twitter.com/share?text={{ $activity->title }}&url={{ Request::url() }}" target="blank" rel="noopener noreferrer" title="Share this on Twitter"  class="col-4 text-center">
            ...
            <a href="https://wa.me/?text={{ Request::url() }}" rel="noopener noreferrer" target="_blank" class="col-4 text-center nav-share-section__wa__desktop">

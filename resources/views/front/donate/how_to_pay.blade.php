...
<main id="page-main-va" class="bg-white" style="padding-bottom: 300px">
    <div class="container">
        ...
        <div class="row mb-3">
            <div class="col-12 text-center mb-2">
                <p class="main-section-text-16 px-2">ke rekening <strong>{{ $payment->bank_username }}</strong>:</p>
            </div>
            <div class="col-12 d-flex justify-content-between">
                <img class="page-main-va__image__rekening" src="{{ asset('storage/'.$payment->path_icon) }}" alt="Virtual Account">
                <input class="page-main-va__input__rekening" type="text" value="{{ $payment->bank_number }}" disabled>
                <div>
        ...
        <div class="row mb-2">
            ...
            <div class="col-12 mb-2 text-center">
                <a class="btn btn-primary" href="{{ url('/payment/' . $transaction->id . '/proof') }}">Upload Bukti Transfer</a>
                <hr>
            </div>
            @endif
            <div class="col-12 text-center">
                <p class="main-section-text-14 px-2">Transfer sebelum <strong>1 x 24 jam</strong> atau donasi kamu otomatis dibatalkan oleh sistem.</p>
            </div>
        </div>
        <!-- BOX -->
                    ...
                    <article class="page-main-va__accordion__list">
                        ...
                        <div class="page-main-va__accordion__item pt-1 pb-4 px-3">
                            ...
                            <div class="d-flex align-items-start">
                                ...
                                <p>Masukkan {{ $payment->bank_number }} dan "Nominal" yang akan dibayarkan, lalu pilih "Lanjut".</p>
                            </div>
                            <div class="d-flex align-items-start">

            ...
            <div class="col-12">
                ...
                @if($wallet_available != 0)
                    <div class="method-wrapper">
                        <h4 class="section-title">Pembayaran di {{envdb('APP_NAME')}}</h4>

                        <div class="method-box payment-item" data-payment="wallet" data-code="0" data-type="wallet">
                            <div class="method-info">
                                <img src="../../assets/img/instructions/wallet.svg" alt="" style="width: 35px; height:35px;">
                                <div class="method-balance-group">
                                    <h4 class="method-name">Saldo Dompet</h4>
                                    <h4 class="method-balance">Rp{{ number_format(Auth::user()->saldo ?? 0, 0, ',', '.') }}</h4>

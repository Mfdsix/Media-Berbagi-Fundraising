...
@section('content')
    <div id="navbar-top">
        <div class="navbar-simple-wrapper">
            <button class="btn-transparent">
                <a href="javascript:void(0)" onclick="window.history.back()" class="text-white">
                    <img src="../../assets/img/icons/back-light.svg" alt="">
                </a>
            </button>
            <h4 class="navbar-wrapper-title">Donasi Saya</h4>
        </div>
    </div>
        ...
        <div class="row">
            ...
            <div class="col-12">
                <div class="history-section">
                    ...
                    <h4 class="section-title mb-3">Catatan Kebaikan</h4>
    ...
    @include('layouts.mb-nav-bottom-primary', ['active' => 'donasi'])
@endsection

			...
			<div class="box-body d-flex align-items-center pd-7 pb-0 row">
				...
				<div class="col-md-6 mb-0">
					<div class="btn-now text-end d-block" id="statistics">
						<a class="h6 font-w500 text-end" href="{{ url('/admin/wakaf/create') }}"><span>Buat Campaign</span></a>
					</div>
				</div>
			</div>
		</div>
		...
		<div class="box client">
			<div class="dropdown">
				...
				<div class="dropdown-menu dropdown-menu-right">
					<a class="dropdown-item" href="{{ url('admin/wakaf/0/edit') }}"><i class="bx bx-edit mr-5"></i>Edit</a>
				</div>
			</div>
			<div class="box-body pt-5 pb-0">
				...
				<div class="group-btn d-flex justify-content-between">
					<a class="bg-btn-pri color-white" href="{{ url('program-instant-wakaf') }}" target="_blank">Preview</a>
				</div>
			</div>
	...
	<div class="col-4 col-sm-12 mb-25">
		<div class="box client" @if($v->is_hidden == 1) style="background:#dbdbdb" @endif>
			...
			<div class="dropdown">
				...
				<div class="dropdown-menu dropdown-menu-right">
					<a class="dropdown-item" href="{{ url('admin/wakaf/'.$v->id.'/edit') }}"><i class="bx bx-edit mr-5"></i>Edit</a>

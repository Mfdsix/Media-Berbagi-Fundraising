...
<div class="row mt--2">
	<div class="col-md-12">
		<form class="box" enctype="multipart/form-data" method="post" action="{{ url('admin/profile') }}">
				...
				<div class="row">
					...
					<div class="col-md-12 col-lg-12">
						...
						<div class="mb-4">
							...
							<input type="number" class="form-control" id="phone" placeholder="Phone" name="phone" value="{{ isset($data) ? $data->phone : old('phone') }}">
							@error('phone')
							<small class="form-text text-danger">{{ $message }}</small>
							@enderror
						</div>

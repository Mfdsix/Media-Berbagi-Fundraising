		...
		<div class="box box-primary">
			<div class="box-body pb-0">
				<div class="btn-now d-block py-0" id="statistics">
					<a class="h6 font-w500" href="{{ url('/admin/campaign') }}"><span>Kembali</span></a>
				</div>
			</div>
		</div>
	</div>
...
<div class="row">
	<div class="col-md-12">
		<form class="box" enctype="multipart/form-data" action="{{ isset($data) ? url('admin/campaign/'.$data->id) : url('admin/campaign') }}" method="post">
			@csrf
			@if(isset($data))

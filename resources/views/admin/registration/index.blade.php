			...
			<div class="box-body d-flex align-items-center pd-7 pb-0 row">
				...
				<div class="col-md-6 mb-0">
					<div class="btn-now text-end d-block" id="statistics">
						<a class="h6 font-w500 text-end" href="{{ url('/admin/pendaftaran/create') }}"><span>Registrasi baru</span></a>
					</div>
				</div>
			</div>
		</div>
		...
		<div class="box client" @if($v->is_hidden == 1) style="background:#dbdbdb" @endif>
			...
			<div class="dropdown">
				...
				<div class="dropdown-menu dropdown-menu-right">
					<a class="dropdown-item" href="{{ url('admin/pendaftaran/'.$v->id.'/edit') }}"><i class="bx bx-edit mr-5"></i>Edit</a>
...
<script type="text/javascript">
	$(document).ready(function(){
		$(".btn-delete-trigger").on("click", function(){
			var id = $(this).data('id');
			$("#form-delete").attr('action', '{{ url("admin/pendaftaran") }}'+'/'+id);

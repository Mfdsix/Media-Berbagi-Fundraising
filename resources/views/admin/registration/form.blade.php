		...
		<div class="box box-primary">
			<div class="box-body pb-0">
				<div class="btn-now d-block py-0" id="statistics">
					<a class="h6 font-w500" href="{{ url('/admin/pendaftaran') }}"><span>Kembali</span></a>
				</div>
			</div>
		</div>
	</div>
...
<div class="row">
	<div class="col-md-12">
		<form class="box" enctype="multipart/form-data" action="{{ isset($data) ? url('admin/pendaftaran/'.$data->id) : url('admin/pendaftaran') }}" method="post">
			@csrf
			@if(isset($data))
			...
			<div class="box-body p-4">
				<div class="row">
					<div class="col-md-12 col-lg-12">
						...
						<div class="mb-4">
							<label for="operational_percentage">Persentase Dana Operasional (dalam %)</label> <a href="javascript:void(0)" title="Digunakan untuk operasional yayasan" class="bg-secondary bg-opacity-75 rounded-pill"><i class="bx bx-question-mark"></i></a>
		...
		<form method="POST" id="status-form" action="{{ url('admin/instant-program/sedekah/switch' ) }}">
			@csrf
		</form>
	</div>
</div>

			...
			<div class="box-body d-flex align-items-center pd-7 pb-0 row">
				...
				<div class="col-md-6 mb-0">
					<div class="btn-now text-end d-block">
						<a class="h6 font-w500 text-end" href="{{ url('/admin/not_confirmed/payment_gateway/export') }}"><span>Export</span></a>
					</div>
				</div>
			</div>
		</div>
...
<div class="row mt--2">
	<div class="col-md-12 mb-3">
		<ul class="nav nav-tabs">
			...
			<li class="nav-item">
				<a class="nav-link" href="{{ url('/admin/not_confirmed/manual') }}">Manual</a>
			</li>
		</ul>
	</div>
</div>
				...
				<table class="table table-striped mt-3" id="table">
					...
					<tbody>
						...
						<tr>
							...
							<td>
								<span class="badge badge-success">{{ $v->payment_method }}</span>
							</td>
							...
							<td>
								<a href="{{ url('admin/not_confirmed/'.$v->id) }}" class="btn btn-sm btn-primary">Lihat Detail</a>
							</td>
						</tr>
						@endforeach
					</tbody>

		...
		<div class="box box-primary">
			<div class="box-body pb-0">
				<div class="btn-now d-block py-0" id="statistics">
					<a class="h6 font-w500" href="{{ url('/admin/all_donation') }}"><span>Kembali</span></a>
				</div>
			</div>
		</div>
	</div>
				...
				<table class="table table-striped">
					<tbody>
						<tr>
							...
							<td width="50%" class="font-weight-bold">{{ $data->title }}</td>
						</tr>
						<tr>
						...
						<tr>
							...
							<td class="font-weight-bold">{{ $data->payment_method }}</td>
						</tr>
						...
						<tr>
							...
							@else
							<td class="font-weight-bold">Belum Mengirim Bukti Pembayaran</td>
							@endif
						</tr>
						@endif
					</tbody>
		...
		<form class="modal-content" method="post" enctype="multipart/form-data" action="{{ url()->current().'/update' }}">
			...
			<div class="modal-body">
				<div class="form-group">
					<label>Nominal</label>
					<input type="text" name="nominal" class="form-control rupiah" value="{{ $data->nominal }}">
				</div>
				<div class="form-group">

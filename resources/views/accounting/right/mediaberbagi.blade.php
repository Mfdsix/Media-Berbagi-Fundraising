			...
			<div class="box-body d-flex align-items-center pd-7 pb-0 row">
				...
				<div class="col-md-6 mb-0">
					<div class="btn-now text-end d-block" id="statistics">
						<a class="h6 font-w500 text-end" href="{{ url('/accounting/mediaberbagi_right/create') }}"><span>Input Pencatatan</span></a>
					</div>
				</div>
			</div>
		</div>
				...
				<table class="table table-striped">
					...
					<tbody>
						...
						<tr>
							...
							<td>
								<a href="{{ url('accounting/mediaberbagi_right/'.$v->id.'/edit') }}" class="btn btn-sm btn-warning"><i class="bx bx-edit"></i></a>
...
<script type="text/javascript">
	$(document).ready(function(){
		$(".btn-delete-trigger").on("click", function(){
			var id = $(this).data('id');
			$("#form-delete").attr('action', '{{ url("accounting/mediaberbagi_right") }}'+'/'+id);
